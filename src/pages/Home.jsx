          ...
          <div className="flex w-full sm:w-auto gap-3">
            {!user.is_anonymous && (
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 bg-blue-600/20 text-blue-400 hover:bg-blue-600/30 border border-blue-600/20 rounded-xl transition cursor-pointer text-center whitespace-nowrap"
              >
                Добавить
              </button>
            )}
