    ...
    <div className="relative">
      <>
        ...
        >
          {CurrentStatus && (
            <CurrentStatus.icon
              className={`w-6 h-6 sm:w-5 sm:h-5 ${CurrentStatus.color}`}
            />
          )}
        ...
        {isStatusMenuOpen && (
          <>
            ...
            />
            <div
              className=" absolute z-50 bottom-full mb-2 left-0 flex flex-col gap-1 p-1 min-w-35 bg-slate-800/60 backdrop-blur-md 
                border border-white/10  rounded-xl shadow-2xl animate-in fade-in zoom-in-95 duration-100 "
            >
