    ...
    <div className="relative">
      <>
        <button
          ...
          className=" z-30 backdrop-blur-sm transition-all p-2 sm:p-1.5 rounded-lg bg-slate-800/30 hover:bg-white/10 cursor-pointer"
        >
          {CurrentRating ? (
            <div className="flex items-center">
              ...
              {CurrentRating > 3 && CurrentRating <= 6 && (
                <Annoyed className={`w-5 h-5 text-amber-500`} />
              )}
              {CurrentRating > 6 && CurrentRating <= 10 && (
        ...
        {isRatingMenuOpen && (
          <>
            ...
            />
            <div
              className="absolute z-50 bottom-full mb-2 right-0 flex gap-1 p-1 min-w-35 bg-slate-800/60 backdrop-blur-md border border-white/10 
